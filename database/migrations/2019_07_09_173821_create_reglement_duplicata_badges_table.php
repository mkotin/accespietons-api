...
class CreateReglementDuplicataBadgesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reglement_duplicata_badges', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reglement_duplicata_badges');
    }
}
